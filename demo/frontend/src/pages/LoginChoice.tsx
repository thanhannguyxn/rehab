      ...
      <div className="max-w-5xl w-full">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <span className="text-3xl font-bold text-gray-800">Rehab System</span>
          </div>
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Chọn Loại Tài Khoản</h1>
          <p className="text-2xl text-gray-600">Bạn là bệnh nhân hay bác sĩ?</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-4xl font-bold text-gray-800 mb-4">Bệnh Nhân</h2>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Đăng nhập để tập luyện phục hồi chức năng với AI
              </p>
              <div className="bg-teal-600 group-hover:bg-teal-700 text-white px-8 py-4 rounded-lg font-bold text-xl inline-block transition">
                Đăng Nhập →
              </div>
            </div>
          </Link>
          ...
          >
            <div className="text-center">
              ...
              <h2 className="text-4xl font-bold text-gray-800 mb-4">Bác Sĩ</h2>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                Quản lý và theo dõi tiến độ của bệnh nhân
              </p>
              <div className="bg-green-600 group-hover:bg-green-700 text-white px-8 py-4 rounded-lg font-bold text-xl inline-block transition">
                Đăng Nhập →
              </div>
            </div>
          </Link>
