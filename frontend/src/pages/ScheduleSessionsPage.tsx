    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black transition-colors duration-300">
      <div className="pt-8 pb-2">
        <div className="max-w-6xl mx-auto px-6">
          <h1 className="text-5xl font-black mb-2 text-gray-900 dark:text-white bg-gradient-to-r from-teal-500 to-cyan-500 dark:from-teal-400 dark:to-cyan-400 bg-clip-text text-transparent capitalize">
            ...
            {schedules.map((item) => (
              <div 
                ...
                className={`bg-white dark:bg-gray-800 rounded-xl border ${
                  item.is_read ? 'border-gray-200 dark:border-gray-700' : 'border-teal-300 dark:border-teal-500/50 shadow-md'
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                      ...
                      <span
                        className={`text-xs font-semibold px-2.5 py-1 rounded-full ${
                          item.is_read 
                            ...
                            : 'bg-teal-100 text-teal-800 dark:bg-teal-900/50 dark:text-teal-300 ring-1 ring-teal-500/20'
                        }`}
                      >
                    ...
                    <div className="space-y-1.5 mt-3">
                      ...
                      {item.note && (
                        <div className="text-sm mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-100 dark:border-blue-800/30">
                          <span className="font-medium text-blue-800 dark:text-blue-300">{t("schedulePage.note")}</span> 
                          <span className="text-blue-900 dark:text-blue-200 ml-1">{item.note}</span>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-row md:flex-col items-stretch justify-end gap-3 mt-2 md:mt-0 min-w-[140px]">
                    {!item.is_read && (
                      <button
                        ...
                        className="flex-1 md:flex-none px-4 py-2.5 rounded-lg text-sm font-medium border-2 border-teal-500 text-teal-600 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-900/30 transition-colors flex items-center justify-center gap-2"
                      >
                    ...
                    <Link
                      to="/exercise"
                      className="flex-1 md:flex-none px-4 py-2.5 rounded-lg text-sm font-medium bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white shadow-md hover:shadow-lg transition-all flex items-center justify-center gap-2"
                    >
